...
class Config:
    ...
    MESSAGE_DUMP = int(config("MESSAGE_DUMP", default="-1002289376063"))  # if not given owner id will be msg dump :)
    DEV_USERS = [
        int(i)
        for i in config(
            "DEV_USERS",
...
class Development:
    ...
    MESSAGE_DUMP = -1002289376063  # Your Private Group ID for logs if not passed your owner id will be msg dump
    DEV_USERS = []
    SUDO_USERS = []
    WHITELIST_USERS = []
